...
source = requests.get('https://finance.yahoo.com/').text
...
yahoo_finance_csv = open("yahoo_finance "+"{:%B %d, %Y}".format(datetime.now())+".csv","w")
csv_writer = csv.writer(yahoo_finance_csv)
